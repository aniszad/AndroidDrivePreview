package com.az.drivepreviewlibrary.api

import android.os.Environment
import android.util.Log
import com.az.drivepreviewlibrary.data.exceptions.DriveDownloadException
    ...
    init {
        ...
        credentialsInputStream.use { `in` ->
            googleCredentials = GoogleCredentials.fromStream(`in`).createScoped(
                com.az.drivepreviewlibrary.api.GoogleDriveApi.Companion.SCOPES
            )
            driveService = Drive.Builder(
                NetHttpTransport(),
                com.az.drivepreviewlibrary.api.GoogleDriveApi.Companion.JSON_FACTORY,
